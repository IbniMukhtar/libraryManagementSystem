...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="#" class="logo"><b>Admin<span>panel</span></b></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="#">Fine List</a></li>
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              <i class="fa fa-th"></i>
              <span>Anounstents</span>
              </a>
            <ul class="sub">
              <li><a href="#">Student Table</a></li>
              <li><a href="responsive_table.html">Books Table</a></li>
              <li><a href="advanced_table.html">Lend BOOks Table</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="morris.html">Delete Admin</a></li>
            </ul>
          </li>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <div class="credits">
          ...
          -->
          Created with bootstrap <a href="#">LosserGroup</a>
        </div>
