    ...
    <section id="main-content">
      <section class="wrapper"
        ...
        <form  action="" method="POST" style="margin-top:20px;" style="float: right;">
          ...
          style="border-radius:25px;border:2px  gray;padding:10px;color:black;height:35px;" placeholder="&nbsp;&nbsp;&nbsp;Search RollNo...">
        </form>
        <h3 style="margin-top:28px;color:green;"><i class="fa fa-users"></i>STUDENT'S TABLE</h3>
              ...
              <table class="table table-bordered table-stripped" style="">
                ...
                <?php
                  if(isset($_POST["submit1"]))
                     {
                       $t1=$_POST["t1"];
                      echo $object->get_data_in_table("SELECT * FROM student_tbl where rollno= $t1");
                     }
                   else{
                       echo $object->get_data_in_table('SELECT * FROM student_tbl ORDER BY id');
                      }
               ?>
                </table>
            </div>
